 ...
 */
final class Version20230821162324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE suivre (id INT AUTO_INCREMENT NOT NULL, id_commande_id INT DEFAULT NULL, id_eleve_id INT DEFAULT NULL, INDEX IDX_3BC593BB9AF8E3A3 (id_commande_id), INDEX IDX_3BC593BB5AB72B27 (id_eleve_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
